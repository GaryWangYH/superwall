...
module.exports = function() {
    ...
    fs.readFile('./static/txt/admin_center_nav.txt', function(err, data) {
        if (err) {
            ...
            function(err, results){
                ...
                res.render('admingly/web/admin_center.ejs', { data,data1,data2,data3, nav, menu, content: "trade_ddos_control", menuClick: 1, itemClick: 1 }); 
    ...
    router.post('/update', urlencodedParser, function(req, res) {
        ...
        async.series([
            function(callback){
                db.query(`UPDATE trade_ddos SET \
                clerk_id='${clerk_id}',\
                os='${os_name}',\
                duration=${duration},\
                ip_sum=${ip_sum},\
            ...
            function(callback){
                if(record==1){
                    db.query(`INSERT INTO record_trade_ddos (pay_id,trade_id,clerk_id,user_id,amount,\
                ...
                common.log_admin(admin_id,'修改ddos高防IP订单状态','修改ddos高防IP订单状态'+change);
