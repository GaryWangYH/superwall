...
module.exports = function() {
    ...
    fs.readFile('./static/txt/admin_center_nav.txt', function(err, data) {
        if (err) {
            ...
            function(err, results){
                ...
                res.render('admingly/web/admin_center.ejs', { data,data1,data2,data3, nav, menu, content: "trade_hss_control", menuClick: 1, itemClick: 0 }); 
    ...
    router.post('/update', urlencodedParser, function(req, res) {
        ...
        async.series([
            ...
            function(callback){
                if(record==1){
                    db.query(`INSERT INTO record_trade_hss (pay_id,trade_id,clerk_id,user_id,amount,\
                ...
                common.log_admin(admin_id,'修改高防服务器订单状态','修改高防服务器订单状态'+change);
